...
Voorbeelden (vanuit quantbuild-root, of overal met juiste paden):
...
Vereist: QuantLog-repo naast quantbuild of QUANTLOG_REPO_PATH.
"""
...
def _resolve_quantlog_repo(cli_path: str | None) -> Path:
    ...
    if found is not None:
        return found
    sys.stderr.write(
        "QuantLog repo not found. Clone quantlog naast quantbuild of zet QUANTLOG_REPO_PATH.\n"
    )
    sys.exit(2)
