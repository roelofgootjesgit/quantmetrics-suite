...
# Default: sibling folders under the parent directory of quantbuild.
# Folders: QuantBuild (quantbuild), QuantBridge (quantbridge), QuantLog (quantlog), QuantOS (quantmetrics_os).
#
# Usage:
