...
Voor **QuantBuild E1** geldt: credentials horen in **`os.environ`**; een repo-`.env` is optionele dev-hulp (wordt door `python-dotenv` ingeladen). Canonieke namen en VPS/systemd: **`docs/CREDENTIALS_AND_ENVIRONMENT.md`** in de quantbuild-repo.
