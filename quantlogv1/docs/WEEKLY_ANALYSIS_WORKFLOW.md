...
Herhaalbare stappen om productie-events van de VPS (of andere host) op je laptop te analyseren met **deze** repo (`quantlogv1`). De CLI hoeft niet op de server te draaien; je kopieert alleen de JSONL-data.
...
```text
/opt/quantbuild/quantbuildv1/data/quantlog_events/YYYY-MM-DD/
```
...
`/opt/quantbuild/quantbuildv1/data/quantlog_events`
...
| **2** | Naar de event-map | `cd /opt/quantbuild/quantbuildv1/data/quantlog_events` |
...
| Stap | Commando |
|------|----------|
| **19** | `EVENTS="/opt/quantbuild/quantbuildv1/data/quantlog_events"` |
...
| Stap | Waar | Commando |
|------|------|----------|
| **34** | Laptop | `cd "/pad/naar/jouw/quantlogv1"` |
...
| Stap | Commando |
|------|----------|
| **38** | `cd /opt/quantbuild/quantbuildv1` |
...
| Stap | Commando |
|------|----------|
| **42** | `cd "c:\Users\Gebruiker\quantlogv1"` |
| **43** | `New-Item -ItemType Directory -Force -Path "data\imported\week-2026-W14"` |
| **44** | `scp -r "jouwuser@jouw.vps.example:/opt/quantbuild/quantbuildv1/data/quantlog_events/2026-03-31" "data\imported\week-2026-W14"` |
| **45** | `scp -r "jouwuser@jouw.vps.example:/opt/quantbuild/quantbuildv1/data/quantlog_events/2026-04-01" "data\imported\week-2026-W14"` |
| **46** | `scp -r "jouwuser@jouw.vps.example:/opt/quantbuild/quantbuildv1/data/quantlog_events/2026-04-02" "data\imported\week-2026-W14"` |
| **47** | `scp -r "jouwuser@jouw.vps.example:/opt/quantbuild/quantbuildv1/data/quantlog_events/2026-04-03" "data\imported\week-2026-W14"` |
| **48** | `scp -r "jouwuser@jouw.vps.example:/opt/quantbuild/quantbuildv1/data/quantlog_events/2026-04-04" "data\imported\week-2026-W14"` |
| **49** | `scp -r "jouwuser@jouw.vps.example:/opt/quantbuild/quantbuildv1/data/quantlog_events/2026-04-05" "data\imported\week-2026-W14"` |
| **50** | `scp -r "jouwuser@jouw.vps.example:/opt/quantbuild/quantbuildv1/data/quantlog_events/2026-04-06" "data\imported\week-2026-W14"` |
...
| Stap | Commando |
|------|----------|
| **51** | `cd "c:\Users\Gebruiker\quantlogv1"` |
...
$remoteBase = "${User}@${VpsHost}:/opt/quantbuild/quantbuildv1/data/quantlog_events"
$local = "c:\Users\Gebruiker\quantlogv1\data\imported\week-2026-W14"
...
```powershell
$remote = "USER@HOST:/opt/quantbuild/quantbuildv1/data/quantlog_events"
$local  = "c:\Users\Gebruiker\quantlogv1\data\imported\week-2026-W14"
New-Item -ItemType Directory -Force -Path $local | Out-Null
...
```bash
rsync -avz -e ssh USER@HOST:/opt/quantbuild/quantbuildv1/data/quantlog_events/2026-04-0{1,2,3}/ \
  "./data/imported/week-2026-W14/"
```
