...
We ran an **A/B-style matrix**: same strategy quality engine (SQE) and guard semantics, **controlled changes** to horizon and throughput (e.g. baseline calendar window vs multi-year windows vs expanded relaxation experiments), each producing:
