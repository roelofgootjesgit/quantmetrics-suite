...
| QuantBridge — Execution Engine (`quantbridge`) | `main` | `ccdea09a4e83ef1c401b14aae18d20c2ecec7cc9` | Make observability sink QuantLog-compatible with canonical envelope |
| QuantLog — Observability Layer (`quantlog`) | `main` | `c4f12fd10853ac64aa5cbb83067c87b1201df0cd` | Acceptance 001 resultaten ingevuld + QuantLog CLI |
...
- **Dagmap:** `quantbuild/data/quantlog_events/2026-03-29/`
