...
```text
/opt/quantbuild/quantbuildv1    # deze repo
/opt/quantbuild/quantbridgev1      # QuantBridge (indien van toepassing)
...
1. Verbonden met Remote SSH → **File → Open Folder** → `/opt/quantbuild/quantbuildv1` (volledige pad in het padveld plakken mag).
